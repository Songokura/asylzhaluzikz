...
/* ---------------- КОНТАКТЫ (единственное место) ----------------
   Номер от клиента 15.09.2026, на нём же WhatsApp. Всё остальное
   (tel:, wa.me, текст номера в шапке, меню, контактах, панели) подставится само. */
var CONTACT = {
  phone: "+77076067729",          /* tel: */
  phoneView: "+7 707 606 77 29",  /* как показываем */
  wa: "77076067729",              /* wa.me/ */
  ig: "asyl.zhaluzi.kz"
};
...
var TICK = ["Роллшторы Mini","Классические роллшторы","День-Ночь","Блэкаут","Кассетные роллшторы","Вертикальные жалюзи","Горизонтальные жалюзи","Плиссе","Дикей тюль","Москитные сетки плиссе","Бесплатный замер и монтаж","Изготовление от 24 часов","Гарантия 365 дней"];
